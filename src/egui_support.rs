...
fn check_egui_wants_focus(
    #[cfg(feature = "bevy_egui_0_40")] mut contexts: Query<(
        Entity,
        &mut bevy_egui_0_40::EguiContext,
    )>,
    #[cfg(feature = "bevy_egui_0_40")] window_to_egui: Res<
        bevy_egui_0_40::input::WindowToEguiContextMap,
    >,
    ...
    for (entity, mut ctx) in contexts.iter_mut() {
        ...
        if egui_ctx.egui_wants_pointer_input() || egui_ctx.egui_wants_keyboard_input() {
